...
class HTML extends Kohana_HTML
{
	...
	public static function wysiwyg($name, $value = '', $css = '/css/ckeditor.css', $height = '260', $width = '98%')
	{
		...
		$CKEditor->basePath = $url_base . 'js/ckeditor/';
	
		$CKEditor->config['height'] = $height . 'px';
		$CKEditor->config['width']  = $width;
	
		$CKEditor->config['filebrowserBrowseUrl']      = $url_base . 'js/ckfinder/ckfinder.html';
		$CKEditor->config['filebrowserImageBrowseUrl'] = $url_base . 'js/ckfinder/ckfinder.html?type=Images';
		$CKEditor->config['filebrowserFlashBrowseUrl'] = $url_base . 'js/ckfinder/ckfinder.html?type=Flash';
		$CKEditor->config['filebrowserUploadUrl']      = $url_base . 'js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
		$CKEditor->config['filebrowserImageUploadUrl'] = $url_base . 'js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';
		$CKEditor->config['filebrowserFlashUploadUrl'] = $url_base . 'js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash';
