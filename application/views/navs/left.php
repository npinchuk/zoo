                  ...
                  <div class="vd_mega-menu"  data-intro="<strong>Tabs Menu</strong><br/>Can be placed for dropdown menu, tabs, or user profile. Responsive for medium and small size navigation." data-step=3>
                    <ul class="mega-ul">
                      <li id="home" class="one-icon mega-li"> 
                        <a class="mega-link  vd_bg-blue" href="/fe/javascript:void(0);"  data-action="click-trigger">
                      ...
                      <li id="test-2" class="one-icon mega-li"> 
                        <a class="mega-link vd_bg-yellow " href="/fe/javascript:void(0);" data-action="click-trigger">
                          <span class="mega-icon">
                          ...
                          <div class="child-menu">  
                            ...
                            <div class="vd_textarea-menu vd_bg-yellow vd_bd-yellow" >
                              <ul class="nav nav-pills ">
                                <li class="one-icon">
                                  <a data-toggle="tab-post" href="/fe/javascript:void(0);">
                                ...
                                <li class="pull-right">
                                  <a data-toggle="tab-post" href="/fe/javascript:void(0);" style="border-left:1px solid rgba(255,255,255,.3)">
                                    <span class="menu-icon">
                      ...
                      <li id="test" class="one-icon mega-li"> 
                        <a class="mega-link vd_bg-red" href="/fe/javascript:void(0);" data-action="click-trigger">
                          <span class="mega-icon">
                ...
                <ul>
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        ...
                        <li>
                          <a href="/fe/index-analytics.html">
                            <span class="menu-text">Analytics Dashboard</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/index-blogging.html">
                            <span class="menu-text">Blogging Dashboard</span>  
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/index-event-management.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>  
                        <li>
                          <a href="/fe/skin-clean-minimalist.html">
                            <span class="menu-text">Clean Minimalist Nav</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/skin-nav-medium-profile-dark.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"   data-action="click-target">
                      <ul class="clearfix">
                        <li> 
                          <a href="/fe/javascript:" data-action="click-trigger"> 
                            <span class="menu-text">Side Navigation</span> 
                            <span class="menu-badge"><span class="badge vd_bg-black-30"><i class="fa fa-angle-down"></i></span></span>
                          </a> 
                          <div class="child-menu"   data-action="click-target">
                            <ul class="clearfix">
                              <li> <a href="/fe/nav-side-large-menu-tab.html"> 
                                  <span class="menu-text">Large Menu Tab</span> 
                                </a>   
                              </li>
                              <li> <a href="/fe/nav-side-large-tabs-tab.html"> 
                                  <span class="menu-text">Large Tabs Tab</span> 
                                </a>   
                              </li>
                              <li> <a href="/fe/nav-side-large-profile-tab.html"> 
                                  <span class="menu-text">Large Profile Tab</span> 
                                </a>   
                              </li>
                              <li> <a href="/fe/nav-side-large-no-tab.html"> 
                                  <span class="menu-text">Large No Tab</span> 
                                </a>   
                              </li> 
                              <li> <a href="/fe/nav-side-large-chat-content.html"> 
                                  <span class="menu-text">Large Chat Content</span> 
                                </a>   
                              </li>
                              <li> <a href="/fe/nav-side-large-email.html"> 
                                  <span class="menu-text">Large Email</span> 
                                </a>   
                              </li>                                                                                   
                              <li> <a href="/fe/nav-side-medium-menu-tab.html"> 
                                  <span class="menu-text">Medium Menu Tab </span>
                                </a>                                     
                              </li>                            
                              <li> <a href="/fe/nav-side-medium-tabs-tab.html"> 
                                  <span class="menu-text">Medium Tabs Tab</span>
                                </a>                                     
                              </li>
                              <li> <a href="/fe/nav-side-medium-profile-tab.html"> 
                                  <span class="menu-text">Medium Profile Tab </span>
                                  <span class="menu-badge"><span class="badge vd_bg-red">HOT</span></span>     
                                </a> 
                              </li>
                              <li> <a href="/fe/nav-side-medium-no-tab.html"> 
                                  <span class="menu-text">Medium No Tab </span>  
                                </a> 
                              </li>                            
                              <li> <a href="/fe/nav-side-small-menu-tab.html"> 
                                  <span class="menu-text">Small Menu Tab</span>
                                </a> 
                              </li>
                              <li> <a href="/fe/nav-side-small-tabs-tab.html"> 
                                  <span class="menu-text">Small Tabs Tab</span>
                                </a> 
                              </li>
                              <li> <a href="/fe/nav-side-small-profile-tab.html"> 
                                  <span class="menu-text">Small Profile Tab</span>
                                </a> 
                              </li>
                              <li> <a href="/fe/nav-side-small-no-tab.html"> 
                        ...
                        <li> 
                          ...
                          <div class="child-menu"   data-action="click-target">
                            <ul class="clearfix">
                              <li> <a href="/fe/nav-top-search.html">Search </a> </li>
                              <li> <a href="/fe/nav-top-menu.html">Mega Menu </a> </li>
                              <li> <a href="/fe/nav-top-clean-style.html"> Clean Style </a> </li>                            
                            </ul>
                          </div>              
                        </li>
                        <li> 
                          ...
                          <div class="child-menu"   data-action="click-target">
                            <ul class="clearfix">
                              <li> <a href="/fe/nav-bottom-widget.html"> Chat Widget </a> </li>
                              <li> <a href="/fe/nav-bottom-clean-menu.html"> Clean With Menu </a> </li>
                              <li> <a href="/fe/nav-bottom-clean-center.html"> Clean Center Text </a> </li>
                            </ul>
                          </div>               
                        </li>                                 
                      </ul>
                  ...
                  <li>
                    <a href="/fe/functions-index.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/forms-elements.html">
                            <span class="menu-text">Form Elements</span>  
                          </a>
                        </li>              
                        <li>
                          <a href="/fe/forms-layouts.html">
                            <span class="menu-text">Form Layouts</span>  
                          </a>
                        </li>                
                        <li>
                          <a href="/fe/forms-wizard.html">
                            <span class="menu-text">Form Wizard</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/forms-validation.html">
                            <span class="menu-text">Form Validation</span>  
                          </a>
                        </li>                   
                        <li>
                          <a href="/fe/forms-sliders.html">
                            <span class="menu-text">Form Slider</span>  
                          </a>
                        </li>                 
                        <li>
                          <a href="/fe/forms-multiple-file-upload.html">
                            <span class="menu-text">Form Multiple File Upload</span>  
                          </a>
                        </li>                                                                                      
                        <li>
                          <a href="/fe/forms-inline-editing.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/ui-panels.html">
                            <span class="menu-text">Panels</span>  
                          </a>
                        </li>    
                        <li>
                          <a href="/fe/ui-panels-draggable.html">
                            <span class="menu-text">Panels Draggable</span>  
                          </a>
                        </li>                              
                        <li>
                          <a href="/fe/ui-buttons.html">
                            <span class="menu-text">Buttons</span>  
                          </a>
                        </li>                
                        <li>
                          <a href="/fe/ui-typography.html">
                            <span class="menu-text">Typography</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/ui-icons.html">
                            <span class="menu-text">Icons</span>  
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/ui-tabs-accordion.html">
                            <span class="menu-text">Tabs and Accordion</span>  
                          </a>
                        </li>
                        <li>
                          <a href="/fe/ui-alert-notifications.html">
                            <span class="menu-text">Alert and Notifications</span>  
                          </a>
                        </li>                
                        <li>
                          <a href="/fe/ui-pricing-tables.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/listtables-tables-variation.html">
                            <span class="menu-text">Tables Variation</span>  
                          </a>
                        </li>              
                        <li>
                          <a href="/fe/listtables-data-tables.html">
                            <span class="menu-text">Data Tables</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/listtables-small-list.html">
                            <span class="menu-text">Small List</span>  
                          </a>
                        </li>
                        <li>
                          <a href="/fe/listtables-medium-list.html">
                            <span class="menu-text">Medium List</span>  
                          </a>
                        </li>   
                        <li>
                          <a href="/fe/listtables-blog-small-list.html">
                            <span class="menu-text">Blog Small List</span>  
                          </a>
                        </li>
                        <li>
                          <a href="/fe/listtables-blog-large-list.html">
                            <span class="menu-text">Blog Large List</span>  
                          </a>
                        </li>                
                        <li>
                          <a href="/fe/listtables-grid-list.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/charts-morris.html">
                            <span class="menu-text">Morris Chart</span>  
                          </a>
                        </li>              
                        <li>
                          <a href="/fe/charts-flot.html">
                            <span class="menu-text">Flot Chart</span>  
                          </a>                
                        </li>                                                                                 
                        <li>
                          <a href="/fe/charts-sparkline.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/maps-vector.html">
                            <span class="menu-text">Vector Map</span>  
                          </a>
                        </li>              
                        <li>
                          <a href="/fe/maps-google.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/gallery-page.html">
                            <span class="menu-text">Gallery Page</span>  
                          </a>
                        </li>   
                        <li>
                          <a href="/fe/gallery-masonry.html">
                            <span class="menu-text">Gallery Masonry</span>  
                          </a>
                        </li>      
                        <li>
                          <a href="/fe/gallery-text-filter.html">
                  ...
                  <li>
                    ...
                    <div class="child-menu"  data-action="click-target">
                      <ul>
                        <li>
                          <a href="/fe/pages-custom-product.html">
                            <span class="menu-text">Custom Product Form</span>
                            <span class="menu-badge"><span class="badge vd_bg-red">HOT</span></span>     
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/pages-essay.html">
                            <span class="menu-text">Essay Form</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/pages-invoice.html">
                            <span class="menu-text">Invoice</span>  
                          </a>
                        </li>                 
                        <li>
                          <a href="/fe/pages-user-profile-form.html">
                            <span class="menu-text">User Profiles Form</span>  
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/pages-user-profile.html">
                            <span class="menu-text">User Profiles Page</span>  
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/pages-timeline.html">
                            <span class="menu-text">Timeline</span>  
                            <span class="menu-badge"><span class="badge vd_bg-yellow">NEW</span></span>                        
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/pages-calendar.html">
                            <span class="menu-text">Calendar</span>  
                            <span class="menu-badge"><span class="badge vd_bg-yellow">NEW</span></span>                        
                          </a>
                        </li>    
                        <li>
                          <a href="/fe/pages-ecommerce-products.html">
                            <span class="menu-text">Ecommerce Products List</span>  
                            <span class="menu-badge"><span class="badge vd_bg-yellow">NEW</span></span>                        
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/pages-ecommerce-product-add.html">
                            <span class="menu-text">Ecommerce Product add</span>  
                            <span class="menu-badge"><span class="badge vd_bg-yellow">NEW</span></span>                        
                          </a>
                        </li>                                                                                                                                                      
                        <li>
                          <a href="/fe/pages-login.html">
                            <span class="menu-text">Login Page</span>  
                          </a>
                        </li>
                        <li>
                          <a href="/fe/pages-forget-password.html">
                            <span class="menu-text">Forget Password Page</span>  
                          </a>
                        </li>                
                        <li>
                          <a href="/fe/pages-register.html">
                            <span class="menu-text">Register Page</span>  
                          </a>
                        </li>  
                        <li>
                          <a href="/fe/pages-logout.html">
                            <span class="menu-text">Log Out Page</span>  
                          </a>
                        </li> 
                        <li>
                          <a href="/fe/pages-lockscreen.html">
                            <span class="menu-text">Lock Screen</span>  
                            <span class="menu-badge"><span class="badge vd_bg-yellow">NEW</span></span>                        
                          </a>
                        </li>                                              
                        <li>
                          <a href="/fe/pages-404-error.html">
                            <span class="menu-text">404 Error</span>  
                          </a>
                        </li>
                        <li>
                          <a href="/fe/pages-500-error.html">
                ...
                <div class="navbar-search-wrapper">
                  <div class="navbar-search vd_bg-black-30">
                    ...
                    <div class="pull-right search-config">                                
                      <a  data-toggle="dropdown" href="/fe/javascript:void(0);" class="dropdown-toggle" ><span class="prepend-icon vd_grey"><i class="fa fa-cog"></i></span></a>
