  ...
  <div class="col-md-12">
    <div class="box">
      ...
      <ul class="nav nav-tabs">
        ...
        <li><a href="#tab_table3" data-toggle="tab"><i class="icon-eye-close"></i> Блок. <span class="label label-danger"><?php echo $adblockcount; ?></span> </a></li>
         <li><a href="#tab_table4" data-toggle="tab"><i class="icon-time"></i> Мод. <span class="label label-danger"><?php echo $admodcount; ?></span> </a></li>
          <li><a href="#tab_table5" data-toggle="tab"><i class="icon-trash"></i> Уд. <span class="label label-danger"><?php echo $addelcount; ?></span> </a></li>
      </ul>
      <div class="tab-content bottom-margin">
              ...
              <table class="table table-bordered table-hover datatable">
                ...
                <tbody>
                  ...
                  foreach ($activeads as $value) {
                    ...
                    echo "</td>";
                    echo "<td>";
                    echo "<a href='/admin/changestatus/".$value->id."/1' class='btn btn-iconed btn-success btn-xs'><i class='icon-ok-sign'></i></a>";
                    echo "<a href='/admin/changestatus/".$value->id."/4' class='btn btn-iconed btn-default btn-xs'><i class='icon-time'></i></a>";
                    echo "<a href='/admin/changestatus/".$value->id."/3' class='btn btn-iconed btn-danger btn-xs'><i class='icon-ban-circle'></i></a>";
                    echo "<a href='/admin/changestatus/".$value->id."/2' class='btn btn-iconed btn-primary btn-xs'><i class='icon-flag'></i></a>";
                    echo "<a href='/admin/changestatus/".$value->id."/5' class='btn btn-iconed btn-warning btn-xs'><i class='icon-trash'></i></a>";
                    echo "<a  href='/admin/edit/".$value->id."' class='btn btn-iconed btn-success btn-xs'><i class='icon-money'></i></a>";
                    echo "<a  href='/admin/edit/".$value->id."' class='btn btn-iconed btn-default btn-xs'><i class='icon-cog'></i></a>";
                    
                    echo "</td>";
                    echo "<td>";
                    echo $value->author->surname." ".$value->author->name;
                    echo "</td>";
                    echo "</tr>";
                  }
                  ?>
        ...
        <div class="tab-pane" id="tab_table4">
          <div class="shadowed-bottom">
            <div class="row">
              <div class="col-sm-3 bordered">
                <div class="value-block padded-left text-center">
        ...
        <div class="tab-pane " id="tab_table5">
          <div class="shadowed-bottom">
            <div class="row">
              <div class="col-sm-3 bordered">
                <div class="value-block padded-left text-center">
